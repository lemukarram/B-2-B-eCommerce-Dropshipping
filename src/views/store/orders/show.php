...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/store/orders" class="btn btn-outline-secondary btn-sm">Back to Orders</a>
</div>
                ...
                <table class="table mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="text-end">Line Total (Selling)</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">PKR <?= number_format($item['wholesale_price_snapshot'], 2) ?></td>
                    ...
                    <tfoot class="table-light">
                        <tr>
                            <td colspan="4" class="text-end">Total Selling Price:</td>
                            <td class="text-end fw-bold">PKR <?= number_format($order['total_selling_price'], 2) ?></td>
                        </tr>
                        <tr>
                            <td colspan="4" class="text-end text-muted">Total Wholesale Cost:</td>
                            <td class="text-end text-muted">- PKR <?= number_format($order['total_wholesale_price'], 2) ?></td>
                        </tr>
                        <tr>
                            <td colspan="4" class="text-end text-muted">Delivery Charge:</td>
                            <td class="text-end text-muted">- PKR <?= number_format($order['delivery_charge'], 2) ?></td>
                        </tr>
                        <tr class="table-success">
                            <td colspan="4" class="text-end fw-bold">Your Profit:</td>
                            <td class="text-end fw-bold text-success fs-5">
                                <?= $order['store_profit'] !== null
                                    ? 'PKR ' . number_format($order['store_profit'], 2)
    ...
    <div class="col-md-4">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body small">
                ...
                <p class="mb-1"><i class="bi bi-telephone"></i> <?= e($order['customer_phone']) ?></p>
                <p class="mb-1"><i class="bi bi-geo-alt"></i> <?= e($order['customer_address']) ?></p>
