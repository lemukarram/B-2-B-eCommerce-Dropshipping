...
<div class="row align-items-center py-5 mb-5 animate-fade-in">
    <div class="col-lg-6">
...
</div> <!-- Close container for full-width section -->
...
</div> <!-- Close container for full-width CTA -->
    ...
    <div class="container">
        <div class="row align-items-center text-white">
            <div class="col-md-8">
                ...
                <p class="text-white text-opacity-75 mb-md-0 lead">Register today and get access to thousands of products at wholesale prices.</p>
            </div>
            <div class="col-md-4 text-md-end">
                <a href="/register" class="btn btn-light btn-lg px-5 rounded-pill fw-bold text-primary">Get Started Now</a>
            </div>
        </div>
    </div>
</div>

<div class="container"> <!-- Final re-open to match layout expectation -->
