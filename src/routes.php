...
$router->post('/admin/sellers/:id/payout',       [AdminSeller::class,    'payout'],  ['admin', 'csrf']);
...
$router->post('/admin/stores/:id/payout',        [App\Controllers\Admin\StoreController::class, 'payout'],  ['admin', 'csrf']);
